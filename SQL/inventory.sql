...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 25, 2024 at 12:11 PM
...
(1, 'ร้าน จงเจริญ', '303/46 ม.5 ', 'ต.บ้านแดง', 'อ.เมือง', 'จ.เลย', '0953145784', '2024-07-30 13:13:14'),
...
(31, 'ร้านไม่มี/ไม่จ่าย', '888', 'ฟ้าใหม่', 'ชาติก่อน', 'ชาติหน้า', '0899999999', '2024-09-21 13:32:05');
...
(4, 'สมพร แซ่ม้า', '123/89', 'น้อยมาก', 'เมือง', 'ลำพูน', '0895656542', '2024-08-29 16:00:16'),
(5, 'จิ่มแจ้ม ยิ้มงาม', '89/56', 'ปาดี', 'เมือง', 'นาราธิวาส', '0895655645', '2024-08-29 16:01:45'),
(9, 'ณัฐันนทน์ กลางเคื่อม', '111/74 ม.3\r\nต.พิมลราช', 'ฟหกฟกหฟ', 'อ.บางบัวทอง', 'นนทบุรี', '0955514657', '2024-09-23 08:48:00');
...
(1, 'สายไฟ 5 เมตร', 'สายไฟคุณภาพสูง', 100.00, 11, 1, '2024-07-30 12:33:10', '515996.jpg'),
(2, 'รีโมทแอร์รุ่นv.1', 'ใช้สำหรับเครื่องปรับอากาศรุ่น momo fotu', 120.00, 81, 2, '2024-07-30 12:47:29', '641849.jpg'),
(3, 'รีโมทแอร์รุ่นv.2', 'ใช้กับเครื่องปรับอากาสทุกยี่ห้อ', 100.00, 93, 2, '2024-07-30 12:52:25', '641850.jpg'),
(4, 'หม้อหุงข้าว 120w', 'หม้อหุงข้าว\r\n', 430.00, 91, 3, '2024-08-01 14:13:26', '567315.jpg'),
...
(16, 'หม้อข้าวขนาดเล็ก', '-', 310.00, 130, 3, '2024-08-09 16:45:21', '567314.jpg'),
(17, 'สายแลน 15 เมตร', '-', 450.00, 22, 5, '2024-08-12 14:56:51', '515997.jpg'),
(19, 'AX-4BT', 'เครื่องปรับแต่งเสียงง\r\n\r\n\r\n\r\n\r\n', 3100.00, 22, 7, '2024-08-29 15:38:28', '179906.jpg'),
...
(25, 'ตู็แล็ค', '-', 2000.00, 2, 8, '2024-09-21 13:11:45', 'LINE_ALBUM_ขาตั้งลำโพง+ขาแขวนTV+ตู้ Rack_240802_3.jpg'),
(26, 'ตู้ลำโพงอเนกประสงค์', '--', 2.00, 5, 8, '2024-09-21 13:14:07', '19.jpg'),
(27, 'เสาอากาศ', '-', 170.00, 5, 14, '2024-09-21 13:22:46', '656415.jpg'),
(28, 'เครื่องช่างดิจิตอล', '-', 200.00, 100, 15, '2024-09-21 13:26:23', '4D5D7E37-B1AE-4EA5-9F51-0BAD0FDA238E.jpg'),
(29, 'วิทยุ', '-', 350.00, 11, 14, '2024-09-21 13:41:11', '590951.jpg'),
(30, 'หลอดไฟ', '-', 90.50, 11, 14, '2024-09-21 13:41:59', 'S__967025.jpg'),
(31, 'หฟกฟหก', 'กหฟฟหกก', 1.00, 33, 3, '2024-09-23 05:53:21', '590954.jpg');
...
--
ALTER TABLE `product_costs`
  MODIFY `cost_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;

--
-- AUTO_INCREMENT for table `stock_in`
--
ALTER TABLE `stock_in`
  MODIFY `stock_in_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=66;
